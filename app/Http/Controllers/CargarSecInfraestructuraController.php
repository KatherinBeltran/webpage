...
class CargarSecInfraestructuraController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:cargar-sec-infraestructura.index')->only('index');
    }
    /**
    ...
    {
        return view('cargar-sec-infraestructura');
    }
