...
class PiSecCulturaDashController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:pi-sec-cultura-dash.index')->only('index');
    }
    /**
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE CULTURA Y TURISMO'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-cultura', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}
