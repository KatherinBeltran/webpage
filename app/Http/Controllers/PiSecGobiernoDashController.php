...
class PiSecGobiernoDashController extends Controller
{
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE GOBIERNO'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-gobierno', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}
