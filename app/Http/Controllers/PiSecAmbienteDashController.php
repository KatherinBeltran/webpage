...
class PiSecAmbienteDashController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:pi-sec-ambiente-dash.index')->only('index');
    }
    /**
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE AMBIENTE, MINAS, DESARROLLO RURAL Y PROTECCION ANIMAL'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-ambiente', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}
