...
class PiSecPlaneacionDashController extends Controller
{
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE PLANEACIÓN Y ORDENAMIENTO TERRITORIAL'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-planeacion', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}