...
class PiSecSaludDashController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:pi-sec-salud-dash.index')->only('index');
    }
    /**
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE SALUD'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-salud', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}
