...
class PiSecEducacionDashController extends Controller
{
    public function __construct()
    {
        $this->middleware('can:pi-sec-educacion-dash.index')->only('index');
    }
    /**
    ...
    {
        $entidadResponsable = 'SECRETARÍA DE EDUCACIÓN'; // Reemplaza con el nombre de la entidad deseada
        ...
        return view('reporte-pi-sec-educacion', ['consecutivos' => $consecutivos, 'averages' => $averages]);
    }
}
